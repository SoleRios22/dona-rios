...
const JAR_COLORS: Record<
  string,
  { lid: string; body: string; label: string; badge: string }
> = {
  clay: {
    lid: "#3E5429",
    body: "#8B4A2B",
    ...
    >
      {isBox ? (
        ...
        <svg viewBox="0 0 100 110" width={size}>
          ...
          <path
            d="M20 18 h60 v72 a10 10 0 01-10 10 h-40 a10 10 0 01-10-10z"
            fill={c.body}
            stroke={c.lid}
            strokeWidth="1.5"
          />
